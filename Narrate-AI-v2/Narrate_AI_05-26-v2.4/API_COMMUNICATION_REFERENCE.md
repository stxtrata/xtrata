...
- `/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4`

Main implementation files:

- [index.html](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/index.html)
- [audiobook-v23.js](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/audiobook-v23.js)
- [server.js](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/server.js)
...
Use `fetchBackend()` in [index.html](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/index.html).
...
Use `postJson()` in [audiobook-v23.js](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/audiobook-v23.js).
...
Use `httpRequestJson()` in [server.js](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/server.js).
...
Use `qwenSynthesizeToBuffer()` in [server.js](/Users/melophonic/Documents/GitHub/xtrata/Narrate-AI-v2/Narrate_AI_05-26-v2.4/server.js).
...
Static serving is intentionally whitelisted. The backend serves the main UI, selected documentation files, and runtime media/state directories needed by the local app. Server source files and other repo-root files are not exposed by default.
...
- return server-owned model metadata, pricing, custom voice defaults, and provider limits used by the app
...
```json
{
  ...
  "defaults": {
    ...
    "design_model": "qwen3-tts-vd-2026-01-26",
    "list_page_size": 100,
  ...
  "models": [
    {
      "id": "qwen3-tts-flash",
      "family": "qwen3-tts-flash",
      "rate_per_char_usd": 0.00001,
      "rate_per_10k_chars_usd": 0.1,
...
- startup diagnostics
- future frontend model picker centralization
...
4. `GET /api/voices/catalog` to centralize built-in voice compatibility rules instead of hard-coding them only in the browser
