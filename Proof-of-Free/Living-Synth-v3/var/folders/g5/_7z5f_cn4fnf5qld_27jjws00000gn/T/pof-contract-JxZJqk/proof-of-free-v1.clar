...
;; Engine inscription: 12345
;; Engine SHA-256: abababababababababababababababababababababababababababababababab
;;
...
(define-constant POF-ENGINE-ID u12345)
(define-constant POF-ENGINE-SHA256 0xabababababababababababababababababababababababababababababababab)
...
(define-private (campaign-operator-allowed
  ...
  (campaign {
    ...
    one-per-wallet: bool, require-bns: bool, one-per-bns: bool, active: bool,
    created-at: uint
  })
)
  (or
