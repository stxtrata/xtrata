;; xStrata-v1.0.2 (canonical dedupe + one-call begin)
;;
;; Core posture (v1.0.2):
...
;; 8) Upload sessions are start-or-resume and expire after inactivity (block-height based):
...
;;    - optional uploader-only abandon-upload clears UploadState only (never deletes chunks)
