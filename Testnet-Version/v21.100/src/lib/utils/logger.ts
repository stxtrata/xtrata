...
const LOG_ENABLED_KEY = 'xstrata.log.enabled';
const LOG_LEVEL_KEY = 'xstrata.log.level';
const LOG_TAGS_KEY = 'xstrata.log.tags';
...
const shouldLog = (tag: string, level: LogLevel) => {
...
const emitLog = (
  ...
  const prefix = `[xstrata:${tag}] ${message}`;
