...
export default function App() {
  ...
  const handleResolveMismatch = () => {
    ...
    setWalletSession(walletSessionStore.load());
  };
    ...
    <div className="app">
      ...
      {!tabGuard.isActive && (
        <div className="app__notice">
          <div className="alert">
            <div>
              <strong>Another xStrata tab is active.</strong> This tab is paused
            ...
            <div className="panel__body">
              ...
              {mismatch && (
                <div className="alert">
                  ...
                  <button className="button" onClick={handleResolveMismatch}>
                    {compatibleContract
