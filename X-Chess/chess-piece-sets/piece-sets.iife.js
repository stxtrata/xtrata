...
const KEY_BY_TYPE = { 1: 'p', 2: 'n', 3: 'b', 4: 'r', 5: 'q', 6: 'k' };
 ...
 */
function pieceMarkup(setId, key, color = 'white') {
  const s = set(setId);
 ...
 */
function symbolId(setId, key, color = 'white', idPrefix = 'xp-') {
 ...
 */
function pieceSVG(setId, key, color = 'white', opts = {}) {
  const s = set(setId);
 ...
 */
function spriteDefs(setId, opts = {}) {
 ...
 */
function pieceUse(setId, key, color = 'white', opts = {}) {
 ...
 */
function pieceStandalone(setId, key, color = 'white', theme = {}) {
  const s = set(setId);
...
root.ChessPieceSets = { SETS: SETS, SET_IDS: SET_IDS, PIECE_KEYS: PIECE_KEYS, PIECE_NAMES: PIECE_NAMES, KEY_BY_TYPE: KEY_BY_TYPE, pieceSVG: pieceSVG, pieceUse: pieceUse, pieceMarkup: pieceMarkup, spriteDefs: spriteDefs, pieceStandalone: pieceStandalone, setAttrs: setAttrs, symbolId: symbolId, THEMES: THEMES };
