...
;;
;; Simple USDCx escrow marketplace for Xtrata inscriptions.
;; - list: moves NFT into escrow (market contract principal).
;; - buy: transfers NFT to buyer and USDCx to seller (optional fee).
...
;;
;; Mainnet lock targets: SP3JNSEXAZP4BDSHV0DN3M8R3P0MY0EEBQQZX743X.xtrata-v2-1-0 and SP120SBRBQJ00MCWS7TM5R8WJNTTKD5K0HFRC2CNE.usdcx
