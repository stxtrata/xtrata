...
;;
;; sBTC escrow marketplace with seller-funded fee sponsorship.
;; Extends xtrata-market-sbtc-v1.1:
...
;;
;; Mainnet lock: core allowlisted at deploy (v3-2-3 only; v2 must migrate), extendable via set-nft-allowed
...
;; so listing support never requires a market redeploy again (the v1.0
;; markets were pinned to xtrata-v2-1-0 and rejected v3 inscriptions).
...
(define-constant PAYMENT-TOKEN-CONTRACT 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4.sbtc-token)
