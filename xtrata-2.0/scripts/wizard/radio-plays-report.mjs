...
for(const e of state.entries){
 ...
 report.audit.transactions.push({txid:e.txid,receipt:e.receipt,listen:decodePaidReceipt(e.receipt),requestedFee:e.fee,nonce:e.nonce,bytes:e.bytes,feeChosen:e.feeChosen,feeReason:e.feeReason,feeEstimates:e.feeEstimates,submittedAt:e.submittedAt,confirmedAt:e.confirmedAt,blockHeight:e.blockHeight,confirmationSeconds:e.confirmationSeconds,rejectionReason:e.rejectionReason,actualFee:tx.fee_rate,status:tx.tx_status,canonical:tx.canonical,block:tx.block_height,confirmed,exactHolderTransfer:!!transfer,transfers});
}
