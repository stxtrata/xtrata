...
export class MusicWebBridge {
 ...
 const {method}=data;const keys={pair:['method'],poll:['method','id'],status:['method','token'],setup:['method','token'],support:['method','token','fee'],start:['method','token','id','song'],stop:['method','token'],disconnect:['method','token']};
