;; xtrata-v3-2-3 (testnet deploy variant for FlowProof)
;; Derived from contracts/clarinet/contracts/xtrata-v3.2.3.clar with legacy
;; migration removed (migrate-from-v1, migrate-from-v2-1-0, get-migrated-chunk[-batch]).
;; Inscribe / mint / recursion / relationships / reads are unchanged.
