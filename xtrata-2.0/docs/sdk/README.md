...
As of 2026-07-21 these docs are maintained in the xtrata-2.0 repo alongside
`packages/xtrata-sdk` and `packages/xtrata-reconstruction`. The 2.0 platform
additions (sponsored Clarity 4 market contracts, Inscription Wizard entry
points, multi-asset payment plans) are tracked in
