...
| 2026-09-14-01 | Collection v1.5 explicit deployment target and granular staged fee quote APIs, manager inventory and public mint integration | yes | Fee boundary and missing-read tests, cross-principal simnet mint, guided inventory UI, SDK release rehearsal | Compatibility matrix, workflow quickstart, troubleshooting, collection integration notes | pass | Codex |
| 2026-09-26-01 | Collection v1.6/v1.7 recognition (`isCollectionV15` now v1.5–v1.7), v1.7 fixed collector price (`isFixedPriceCollection`, `quoteCollectionV15Mint(..., { fixedPrice })`), all static core calls pinned on deploy | yes | v1.7 quote tests, v1.7 Clarinet suite (30), deploy pinning tests | `docs/sdk/changelog.md`, `docs/contract-inventory.md` | pass | Claude |
