...
(define-constant SOURCE .gamma-bitcoin-pepe)
(define-constant MAX-FEE u5000000)
(define-constant RESCUE-ENABLED false)
(define-constant RESCUE-DELAY u0)
...
(define-private (source-owner (token-id uint))
  (unwrap-panic (contract-call? .gamma-bitcoin-pepe get-owner token-id)))
