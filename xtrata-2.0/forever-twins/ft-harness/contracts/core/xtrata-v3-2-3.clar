;; [provenance] xtrata-2.0/forever-twins/contracts-reference/xtrata-core/xtrata-v3.2.3.clar - verbatim except migrate-from-v1 / migrate-from-v2-1-0 removed ([simnet] markers)
;; xtrata-v3.2.3
;;
;; Core posture (v3.2.3):
...
;; [simnet] migrate-from-v1 removed: migration path, irrelevant to Forever Twins


;; [simnet] migrate-from-v2-1-0 removed: migration path, irrelevant to Forever Twins
