;; [provenance] boomcrypto/clarity-deployed-contracts@45a7af60 nyc-degens.clar via screener/sources - verbatim except [simnet] lines (7 changed)
;;; NYC Degens
...
(let (
    ...
    (let
        ...
        (begin
            (try! (contract-call? .miamicoin-token transfer total-commission-master tx-sender commission-address-master  (some 0x00))) ;; [simnet] SP466FNC0P7JWTNM2R9T199QRZN1MYEDTAR0KP27.miamicoin-token -> .miamicoin-token
            (try! (contract-call? .miamicoin-token transfer total-commission tx-sender (var-get commission-address) (some 0x00))) ;; [simnet] SP466FNC0P7JWTNM2R9T199QRZN1MYEDTAR0KP27.miamicoin-token -> .miamicoin-token
            (try! (contract-call? .miamicoin-token transfer total-artist tx-sender (var-get artist-address) (some 0x00))) ;; [simnet] SP466FNC0P7JWTNM2R9T199QRZN1MYEDTAR0KP27.miamicoin-token -> .miamicoin-token
            (mint-helper new-owner next-id))
        )
    )
)
...
(let (
    ...
    (let
        ...
        (begin
            (try! (contract-call? .newyorkcitycoin-token transfer total-commission-master tx-sender commission-address-master  (some 0x00))) ;; [simnet] SP2H8PY27SEZ03MWRKS5XABZYQN17ETGQS3527SA5.newyorkcitycoin-token -> .newyorkcitycoin-token
            (try! (contract-call? .newyorkcitycoin-token transfer total-commission tx-sender (var-get commission-address) (some 0x00))) ;; [simnet] SP2H8PY27SEZ03MWRKS5XABZYQN17ETGQS3527SA5.newyorkcitycoin-token -> .newyorkcitycoin-token
            (try! (contract-call? .newyorkcitycoin-token transfer total-artist tx-sender (var-get artist-address) (some 0x00))) ;; [simnet] SP2H8PY27SEZ03MWRKS5XABZYQN17ETGQS3527SA5.newyorkcitycoin-token -> .newyorkcitycoin-token
            (mint-helper new-owner next-id))
        )
    )
)
