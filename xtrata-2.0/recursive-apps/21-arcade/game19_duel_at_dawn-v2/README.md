# game19_duel_at_dawn-v2 Workspace

This workspace is the enhancement lane for `game19_duel_at_dawn`.
...
3. Generate `games/game19_duel_at_dawn-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game19` and id `duel_at_dawn` stable.
