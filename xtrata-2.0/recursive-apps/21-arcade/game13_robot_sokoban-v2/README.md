# game13_robot_sokoban-v2 Workspace

This workspace is the enhancement lane for `game13_robot_sokoban`.
...
3. Generate `games/game13_robot_sokoban-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game13` and id `robot_sokoban` stable.
