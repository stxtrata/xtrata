# game02_neon_runner-v2 Workspace

This workspace is the enhancement lane for `game02_neon_runner`.
...
3. Generate `games/game02_neon_runner-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game02` and id `neon_runner` stable.
