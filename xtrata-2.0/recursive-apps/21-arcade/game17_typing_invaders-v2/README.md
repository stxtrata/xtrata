# game17_typing_invaders-v2 Workspace

This workspace is the enhancement lane for `game17_typing_invaders`.
...
3. Generate `games/game17_typing_invaders-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game17` and id `typing_invaders` stable.
