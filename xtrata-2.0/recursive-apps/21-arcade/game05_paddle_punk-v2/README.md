# game05_paddle_punk-v2 Workspace

This workspace is the enhancement lane for `game05_paddle_punk`.
...
3. Generate `games/game05_paddle_punk-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game05` and id `paddle_punk` stable.
