# game14_bubble_pop-v2 Workspace

This workspace is the enhancement lane for `game14_bubble_pop`.
...
3. Generate `games/game14_bubble_pop-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game14` and id `bubble_pop` stable.
