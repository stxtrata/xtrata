# game15_stealth_grid-v2 Workspace

This workspace is the enhancement lane for `game15_stealth_grid`.
...
3. Generate `games/game15_stealth_grid-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game15` and id `stealth_grid` stable.
