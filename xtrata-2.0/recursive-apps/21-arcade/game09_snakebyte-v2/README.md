# game09_snakebyte-v2 Workspace

This workspace is the enhancement lane for `game09_snakebyte`.
...
3. Generate `games/game09_snakebyte-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game09` and id `snakebyte` stable.
