# game06_meteor_miner-v2 Workspace

This workspace is the enhancement lane for `game06_meteor_miner`.
...
3. Generate `games/game06_meteor_miner-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game06` and id `meteor_miner` stable.
