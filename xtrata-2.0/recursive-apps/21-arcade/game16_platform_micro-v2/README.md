# game16_platform_micro-v2 Workspace

This workspace is the enhancement lane for `game16_platform_micro`.
...
3. Generate `games/game16_platform_micro-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game16` and id `platform_micro` stable.
