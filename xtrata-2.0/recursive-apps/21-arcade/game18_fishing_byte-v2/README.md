# game18_fishing_byte-v2 Workspace

This workspace is the enhancement lane for `game18_fishing_byte`.
...
3. Generate `games/game18_fishing_byte-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game18` and id `fishing_byte` stable.
