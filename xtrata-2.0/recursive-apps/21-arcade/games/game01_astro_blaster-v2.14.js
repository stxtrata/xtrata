 ...
 * Generated At: 2026-02-20T20:12:02.864Z
 * Legacy Source SHA256: 1bf3bfc02101b90eefd9aca2bb1788030f4ff21dadc9d6d984f2ba558dddeab8
 */
...
var Game01 = (function(){
  ...
  function update(){
    ...
    if(!state.verticalMobilityUnlocked && state.powerLevel >= 2){
      state.verticalMobilityUnlocked = true;
      state.mobilityUnlockIntro = 180;
      if(shared && shared.beep){
    ...
    function createRewardsHazardsRuntime(config){
      ...
      function resolveDrop(payload){
        ...
        if(!starvationActive && hazardChance > 0 && rand() < hazardChance && hazards.length > 0){
          ...
          markDrop(cadenceState, context, hazardDrop.pickupType, spreadType);
          return hazardDrop;
        }
        ...
        if(chooseSpread){
          ...
          markDrop(cadenceState, context, spreadDrop.pickupType, spreadType);
          return spreadDrop;
        }
        ...
        markDrop(cadenceState, context, lifeDrop.pickupType, spreadType);
        return lifeDrop;
      }
