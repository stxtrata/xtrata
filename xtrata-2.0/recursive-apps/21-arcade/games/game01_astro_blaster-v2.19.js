 ...
 * Generated At: 2026-02-20T21:02:54.042Z
 * Legacy Source SHA256: fa305391899ba8beabb56aa16d0f0db3cd4ca148b49ee28ebc95fd53f66d280a
 */
...
var Game01 = (function(){
  ...
  function drawHud(){
    ...
    if(state.fireUnlockIntro > 0){
      var fireUnlockAlpha = Math.min(0.88, state.fireUnlockIntro / 180);
      ctx.globalAlpha = fireUnlockAlpha;
      ctx.fillStyle = 'rgba(2,6,16,0.82)';
      ctx.fillRect(0, HEIGHT * 0.56 - 26, WIDTH, 52);
      ctx.fillStyle = '#8bffbe';
      ctx.font = '18px monospace';
      ctx.textAlign = 'center';
      ctx.fillText('AUTO-FIRE ONLINE', WIDTH * 0.5, HEIGHT * 0.56 + 7);
      ctx.textAlign = 'left';
      ctx.globalAlpha = 1;
    }
  }
    ...
    function createRewardsHazardsRuntime(config){
      ...
      function resolveDrop(payload){
        ...
        var dropsSinceMultiplier = cadenceState
          ...
          : multiplierForceEveryDrops;
        var forceMultiplierDrop = !!(multiplierEligible && dropsSinceMultiplier >= multiplierForceEveryDrops);
