 ...
 * Generated At: 2026-02-21T00:19:11.668Z
 * Legacy Source SHA256: a92a0b2a1a1bf5274fe598c0620530bbfd5b1ad3d3719e3a58caafbebc59cd18
 */
...
var Game01 = (function(){
  ...
  function drawPlayer(){
    ...
    if(state.shieldCharges > 0 && state.shieldTimer > 0){
      ...
      ctx.lineWidth = 2;
      ctx.beginPath();
      ctx.arc(p.x + p.w * 0.5, p.y + p.h * 0.54, shieldRadius, 0, Math.PI * 2);
      ctx.stroke();
      ctx.globalAlpha = 1;
    }
      ...
      "drops": [
        {
          ...
          "animation": "pulse",
          "team": "player",
          "trait": "Small score boost plus minor repair."
        },
        {
          "id": "drop-reward_proto_upgrade",
          "label": "Prototype Upgrade",
          "color": "#fff08f",
          "shape": "Power Crate",
          ...
          "animation": "glow",
          "team": "player",
          "trait": "Select one upgrade from a curated trio."
        },
        {
          "id": "drop-reward_thruster_module",
          "label": "Thruster Module",
          "color": "#73f8ff",
          ...
          "animation": "float",
          "team": "player",
          "trait": "Unlocks vertical thrusters for full arena movement."
        },
        {
          "id": "drop-reward_weapon_multiplier",
          "label": "Weapon Multiplier",
          "color": "#ffd66e",
          "shape": "Core Pickup",
          ...
          "animation": "pulse",
          "team": "player",
          "trait": "Improves firing cadence and eventually unlocks auto-fire."
        },
        {
          "id": "drop-reward_aegis_shell",
          "label": "Aegis Shell",
          "color": "#7df2ff",
          "shape": "Defense Crate",
          ...
          "animation": "glow",
          "team": "player",
          "trait": "Grants one temporary shield charge that absorbs a hit."
        },
        {
          "id": "drop-hazard_false_salvage",
          "label": "False Salvage Beacon",
          "color": "#ff6f86",
          "shape": "Hazard Crate",
          "effectLabel": "jam 3.0s",
          "glyph": "!",
          "animation": "blink",
          "team": "enemy",
          "trait": "Looks like a reward but jams weapons briefly. jam 3.0s"
        },
        {
          "id": "drop-hazard_spike_mine_case",
          "label": "Spike Mine Case",
          "color": "#ff6f86",
          "shape": "Hazard Crate",
          "effectLabel": "shard burst x8",
          "glyph": "!",
          "animation": "blink",
          "team": "enemy",
          "trait": "Detonates radial shards on pickup. shard burst x8"
        },
        {
          "id": "drop-hazard_gravity_dud",
          "label": "Gravity Dud",
          "color": "#ff6f86",
          "shape": "Hazard Crate",
          "effectLabel": "slow 22%",
          ...
          "animation": "blink",
          "team": "enemy",
          "trait": "Reduces movement speed and widens incoming aim assist. slow 22%"
        },
        {
          "id": "drop-hazard_ambush_signal",
          "label": "Ambush Signal",
          "color": "#ff6f86",
          "shape": "Hazard Crate",
          "effectLabel": "ambush +6 threat",
          "glyph": "!",
          "animation": "blink",
          "team": "enemy",
          "trait": "Triggers an immediate elite reinforcement wave. ambush +6 threat"
        }
      ],
      "bullets": [
        {
