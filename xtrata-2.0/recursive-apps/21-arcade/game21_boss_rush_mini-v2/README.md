# game21_boss_rush_mini-v2 Workspace

This workspace is the enhancement lane for `game21_boss_rush_mini`.
...
3. Generate `games/game21_boss_rush_mini-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game21` and id `boss_rush_mini` stable.
