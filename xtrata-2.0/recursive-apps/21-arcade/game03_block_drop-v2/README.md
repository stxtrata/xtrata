# game03_block_drop-v2 Workspace

This workspace is the enhancement lane for `game03_block_drop`.
...
3. Generate `games/game03_block_drop-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game03` and id `block_drop` stable.
