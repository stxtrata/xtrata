# game20_circuit_builder-v2 Workspace

This workspace is the enhancement lane for `game20_circuit_builder`.
...
3. Generate `games/game20_circuit_builder-v2.js`.
...
## Runtime Invariants
- Keep symbol `Game20` and id `circuit_builder` stable.
