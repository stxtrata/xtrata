...
for(const path of [...names.map(n=>'scripts/wizard/'+n),'src/lib/radio/artist-credits.mjs']){await mkdir(dirname(join(out,path)),{recursive:true});await copyFile(join(root,path),join(out,path));}
