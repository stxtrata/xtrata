...
it('notifies the selected song before play resolves; pause/resume and seeking do not duplicate',()=>{
 const player=Object.assign(new EventTarget(),{readyState:4,paused:false,ended:false,muted:false,volume:1,duration:61});const notify=vi.fn(),observer=attachAudibleStart(player,notify);
