...
describe('public catalogue controls',()=>{
 ...
 const tracks=[{id:1,title:'<img src=x onerror=alert(1)>',artist:'First',plays:1,completions:1},{id:2,title:'Second',artist:'Other',thumbnail:'/radio/artwork?id=2',plays:8,completions:2}];
