...
function detail(row){
 ...
 el('detail').hidden=false;el('detail').replaceChildren();const h=document.createElement('h2');h.textContent=row.title;el('detail').append(h);
